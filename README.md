...
You can easily [enhance the image]([url](https://develop.sentry.dev/self-hosted/configuration/#updating-basic-configuration)) by `sentry/enhance-image.sh` script (need [getsentry/self-hosted](https://github.com/getsentry/self-hosted) 22.6.0 or higher):
